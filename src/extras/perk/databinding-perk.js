...
export default class DatabindingPerk extends BM.Perk
{
	...
	static DatabindingPerk_onDoCollect(sender, e, ex)
	{
		...
		if (this.settings.get("databinding.settings.autoCollect", true))
		{
	...
	static init(component, options)
	{
		...
		if (component.settings.get("databinding.settings.dataType", "single") === "single")
		{
			...
			component.inventory.set("databinding.bindings", new BindableStore({
				...
				"direction":	component.settings.get("databinding.settings.direction", "two-way"),
			}));
